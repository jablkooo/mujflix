...
class AIBrain {
  ...
  // TODO: nikde se nevolá — zvážit volání při activateProfile(),
  // aby preference postupně "vyprchávaly" (viz cleanup skupina J)
  applyDecay() {
    const e = Date.now(),
