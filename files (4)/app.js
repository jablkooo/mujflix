...
async function loadTileTrailer(e, t, n = "tv", o = null) {
  ...
  const s = `https://www.youtube-nocookie.com/embed/${i}?autoplay=1&mute=1&controls=0&loop=1&playlist=${i}&rel=0&showinfo=0&modestbranding=1&iv_load_policy=3&disablekb=1&fs=0&playsinline=1&cc_load_policy=0&start=12&vq=hd720&hl=cs&widget_referrer=mujflix&enablejsapi=0`;
...
function refreshUserContent() {
  ...
  // Vzdy ukaz "Kdo se diva?" ihned jako prvni vec pri nacteni
